    ...
    $(function() {
        ...
        $('#photo').uploadify({
            ...
            'onUploadStart': function (file) {  
            	var para= { 'name':$("#name").val(),'stock':$("#stock").val(),'price':$("#price").val(),'category':$("#category").val(),'description':$("#description").val(),'path':'${ctx}/assets/img'};
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h3 id="myModalLabel">添加成功</h3>
						</div>
						<div class="modal-body">

							<p class="error-text">添加商品成功</p>
						</div>
